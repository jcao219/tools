...
Usage: cs3110-staff COMMMAND [args]
  ...
  cs3110 harness <targets>             Run the tests in the directory ./tests against all targets.
  cs3110 help                          Displays this message.
  cs3110 reverse <test_name> <targets> Run test named test_name.ml from each of the targets on the various solutions in [reverse_dir].
  cs3110 rubric <sol_dir>              Create a rubric using the implementations in sol_dir to compile the tests.
